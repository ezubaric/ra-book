...
\jbgcomment{https://www.salon.com/2020/06/21/uber-lyft-algorithms-charged-users-more-for-trips-to-non-white-neighborhoods/}
...
\vkcomment{Excellent point. Will talk about this more in person, but this is exactly why I am much more interested in combination of causality and prediction than in “fair based on statistical criteria X”. 
...
\vkcomment{Ethics? I think that there are two separate and very rarely discussed issues with AI:
...
\vkcomment{True. Not to take away from attention on abhorrent  practices such is redlining, but I am wondering is this something where we see single instance of problem and fail to ask is there a larger general problem to solve behind it.
...
However, \citet{spufford-10} in \book{The Fires: How a Computer
...
\vkcomment{Not to beat up on this topic too much (and this is not fair to you as we both know that we don’t have technology to address this today), but malice is just part of the problem. 
...
\vkcomment{Who is equipped to understand that interaction? Not that mandarins in Brussels are my prime choice for wise tech leadership, but my experience in G-MAFIA and academic circles is that there was little to no a priori understanding of how last round of AI would affect society (filter bubbles). 
