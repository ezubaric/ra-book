...
\vkcomment{Interesting intersection with ``age of implementation''}
...
\vkcomment{I like this. Not to go into geek side, but IMHO biggest
  problem of current hybrid AI systems is that we are substituting
  evaluation of the metric for real understanding of causality and
  constraints. }
...
\vkcomment{Not to go into the philosophical topics, but there is a lot
  of the discussion in the philosophical circles about nature of
  malice. Let’s just say for the time being that you can think about
  some evil behavior as mimicry (like is here), but you also have a
  concept of EMERGENT behavior. AI that is using \$ as metric wouldn’t
  need Canyon to emulate.}
